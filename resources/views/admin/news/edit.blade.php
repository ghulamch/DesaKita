...
<div class="p-0 md:p-4">
    <div class="px-4 py-8 md:px-0 md:py-4 max-w-4xl mx-auto">
        <div class="mb-10">
            ...
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Edit Berita</h1>
            <p class="text-slate-500 font-medium mt-1">Perbarui informasi untuk warga.</p>
        </div>
                ...
                <div class="space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div>
                            ...
                            @if($news->image)
                                <div class="mb-4 w-32 h-20 rounded-lg overflow-hidden border border-slate-100">
                            ...
                            <p class="text-[10px] text-slate-400 mt-2 italic">Kosongkan jika tidak ingin mengubah gambar.</p>
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="10" required 
                                  class="w-full px-6 py-4 rounded-2xl border border-slate-200 focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500 outline-none transition-all shadow-sm font-medium">{{ old('content', $news->content) }}</textarea>
